...
class SpotsTest extends DuskTestCase
{
    ...
    public function testIndex()
    {
        $this->browse(function (Browser $browser) {
            $browser->loginAs(\App\User::inRandomOrder()->firstOrFail())->visit(new Index);
        });
    }
    ...
    {
        $this->browse(function (Browser $browser) {
            $browser->loginAs(\App\User::inRandomOrder()->firstOrFail())->visit(new Create);
        });
    }
    ...
    {
        $this->browse(function (Browser $browser) {
            $browser->loginAs(\App\User::permission('update')->firstOrFail())->visit(new Edit);
        });
    }
}
